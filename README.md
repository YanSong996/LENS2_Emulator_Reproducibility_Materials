...
4. Do SHT with $Q=144$ for the stochastic component at each ensemble $r$ and time point $t$ (about 4.2 seconds for each $r$ and each $t$. Without the parallel computation, it takes 4.2*7*(5*365)/3600=14.9 hours.)
